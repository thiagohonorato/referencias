...
var urlPath = 'http://www.teses.usp.br/estante/';
var widgetPath = urlPath + 'widget/';
...
function initJQuery() {
    ...
    if (typeof(jQuery) == 'undefined') {
        ...
        if (! jQueryScriptOutputted) {
            ...
            document.write("<scr" + "ipt type=\"text/javascript\" src=\"" + urlPath + "site/lib/jquery/jquery-latest.js\"></scr" + "ipt>");
        }
        ...
        // jQuery UI is loaded
            ...
            $.getScript(urlPath + 'site/lib/jquery/jquery-ui.min.js');
        }
        ...
        css.attr({
            rel:  "stylesheet",
            type: "text/css",
            href: urlPath + "site/lib/jquery/css/flick/jquery-ui.css"
        });
