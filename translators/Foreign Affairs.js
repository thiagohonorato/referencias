{
	...
	"lastUpdated": "2014-09-09 06:40:00"
}
...
FW.Scraper({
itemType         : 'magazineArticle',
detect           : FW.Xpath('//div[@class="article-title-header"]/h1'),
title            : FW.Xpath('//div[@class="article-title-header"]/h1').text().trim(),
attachments      : [
  {
 	 url: FW.Url(),
  	title: "Foreign Affairs Snapshot",
  	type: "text/html"}],
creators         : FW.Xpath('//div[@class="article-field-authors"]/a').text().cleanAuthor("author"),
date             : FW.Xpath('//div[contains(@class, "article-field-issue")]/a|//div[@class="article-field-date"]/span').text().remove(/Issue/).trim(),
abstractNote     : FW.Xpath('//h2[@class="article-field-subtitle"]').text(),
ISSN			 : "0015-7120",
issue			 : FW.Xpath('//div[contains(@class, "article-field-issue")]/a').text().remove(/Issue/).trim(),
tags            : FW.Xpath('//meta[@name="keywords"]/@content').text().split(/\s*,\s*/).trim(),
publicationTitle : "Foreign Affairs"
});
...
var testCases = [
		...
		"items": [
			{
				...
				"ISSN": "0015-7120",
				"abstractNote": "Why a Strike Is the Least Bad Option",
	...
	{
		"type": "web",
		"url": "http://www.foreignaffairs.com/articles/141847/mark-blyth-and-eric-lonergan/print-less-but-transfer-more",
		"items": [
			{
				"itemType": "magazineArticle",
				...
				"ISSN": "0015-7120",
				"abstractNote": "Why Central Banks Should Give Money Directly to the People",
	...
	{
		"type": "web",
		"url": "http://www.foreignaffairs.com/articles/141964/derek-scissors/modi-misses-the-mark",
		"items": [
			{
				"itemType": "magazineArticle",
				...
				"ISSN": "0015-7120",
				"abstractNote": "India's New Government Lacks Economic Vision",
				"libraryCatalog": "Foreign Affairs",
				"publicationTitle": "Foreign Affairs",
				"url": "http://www.foreignaffairs.com/articles/141964/derek-scissors/modi-misses-the-mark",
				"attachments": [
